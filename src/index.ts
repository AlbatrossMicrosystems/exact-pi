/**
 * exact-pi — exact finite decimal prefixes of pi.
 *
 ...
 *
 * Truncated, NOT rounded — matching how published reference digit tables
 * are written. Rounding at the boundary would emit a
